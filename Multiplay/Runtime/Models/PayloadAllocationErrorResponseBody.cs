...
namespace RocketScience.Services.Multiplay.Models
{
    ...
    internal class PayloadAllocationErrorResponseBody
    {
        ...
        /// </summary>
        /// <param name="error">An error exists.</param>
        /// <param name="errorCode">Numeric error code for the error returned.</param>
        /// <param name="errorMessage">A message describing the error.</param>
        [Preserve]
        public PayloadAllocationErrorResponseBody(bool error, int errorCode, string errorMessage)
        {
            Error = error;
            ErrorCode = errorCode;
        ...
        /// <summary>
        /// Numeric error code for the error returned.
        /// </summary>
        [Preserve]
