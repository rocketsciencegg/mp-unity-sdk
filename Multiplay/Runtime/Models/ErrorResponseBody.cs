...
namespace RocketScience.Services.Multiplay.Models
{
    ...
    internal class ErrorResponseBody
    {
        ...
        /// </summary>
        /// <param name="status">The value of the status code returned in this HTTP response.</param>
        ...
        /// <param name="title">The status phrase for the HTTP response returned.</param>
        [Preserve]
        ...
        /// <summary>
        /// The value of the status code returned in this HTTP response.
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// The status phrase for the HTTP response returned.
        /// </summary>
        [Preserve]
