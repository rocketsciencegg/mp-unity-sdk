...
namespace RocketScience.Services.Multiplay.Reservation
{
    ...
    /// <summary>
    /// ReservationApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class ReservationApiBaseRequest
    {
        /// <summary>
    ...
    /// <summary>
    /// V1ServersServerIdReservationsDeleteRequest
    /// Unreserve server by ID
    /// </summary>
    [Preserve]
    internal class V1ServersServerIdReservationsDeleteRequest : ReservationApiBaseRequest
    {
        ...
        /// <summary>
        /// V1ServersServerIdReservationsDelete Request Object.
        /// Unreserve server by ID
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        [Preserve]
        public V1ServersServerIdReservationsDeleteRequest(long serverId)
        {
            ServerId = serverId;

            PathAndQueryParams = $"/v1/servers/{serverId}/reservations";
    ...
    /// <summary>
    /// V1ServersServerIdReservationsPostRequest
    /// Reserve server by ID
    /// </summary>
    [Preserve]
    internal class V1ServersServerIdReservationsPostRequest : ReservationApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        public long ServerId { get; }
        ...
        /// <summary>
        /// V1ServersServerIdReservationsPost Request Object.
        /// Reserve server by ID
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        /// <param name="body">Additional parameters supplied to the reservation request.</param>
        [Preserve]
        public V1ServersServerIdReservationsPostRequest(long serverId, object body = default(object))
        {
            ServerId = serverId;
