...
namespace RocketScience.Services.Multiplay.Payload
{
    ...
    internal class PayloadAllocationRequest : PayloadApiBaseRequest
    {
        ...
        public PayloadAllocationRequest(System.Guid allocationId)
        {
            ...
            PathAndQueryParams = $"/v1/payload/allocations/{allocationId}";
    ...
    /// <summary>
    /// PayloadAllocationUnversionedRequest
    /// Retrieve the payload for an allocation
    /// </summary>
    [Preserve]
    internal class PayloadAllocationUnversionedRequest : PayloadApiBaseRequest
    {
        /// <summary>Accessor for allocationId </summary>
        [Preserve]
        public System.Guid AllocationId { get; }
        ...
        /// <summary>
        /// PayloadAllocationUnversioned Request Object.
        /// Retrieve the payload for an allocation
        /// </summary>
        /// <param name="allocationId">ID of the game server allocation.</param>
        [Preserve]
        public PayloadAllocationUnversionedRequest(System.Guid allocationId)
        {
            AllocationId = allocationId;
    ...
    /// <summary>
    /// PayloadTokenBadVersionV4Request
    /// Retrieve a JWT token for use with the payload APIs
    /// </summary>
    [Preserve]
    internal class PayloadTokenBadVersionV4Request : PayloadApiBaseRequest
    {
        string PathAndQueryParams;

        /// <summary>
        /// PayloadTokenBadVersionV4 Request Object.
        /// Retrieve a JWT token for use with the payload APIs
        /// </summary>
        [Preserve]
        public PayloadTokenBadVersionV4Request()
        {
            PathAndQueryParams = $"/v4/token";
    ...
    /// <summary>
    /// PayloadTokenUnversionedRequest
    /// Retrieve a JWT token for use with the payload APIs
    /// </summary>
    [Preserve]
    internal class PayloadTokenUnversionedRequest : PayloadApiBaseRequest
    {
        string PathAndQueryParams;

        /// <summary>
        /// PayloadTokenUnversioned Request Object.
        /// Retrieve a JWT token for use with the payload APIs
        /// </summary>
        [Preserve]
        public PayloadTokenUnversionedRequest()
        {
