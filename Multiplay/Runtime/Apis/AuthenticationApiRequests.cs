...
namespace RocketScience.Services.Multiplay.Authentication
{
    ...
    /// <summary>
    /// AuthenticationApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class AuthenticationApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class PayloadTokenRequest : AuthenticationApiBaseRequest
    {
        ...
        {
            PathAndQueryParams = $"/v1/payload/token";
    ...
    /// <summary>
    /// PayloadTokenClanforgeRequest
    /// Retrieve a Clanforge JWT token for use with legacy Clanforge payload APIs
    /// </summary>
    [Preserve]
    internal class PayloadTokenClanforgeRequest : AuthenticationApiBaseRequest
    {
        string PathAndQueryParams;

        /// <summary>
        /// PayloadTokenClanforge Request Object.
        /// Retrieve a Clanforge JWT token for use with legacy Clanforge payload APIs
        /// </summary>
        [Preserve]
        public PayloadTokenClanforgeRequest()
        {
            PathAndQueryParams = $"/v1/payload/token-clanforge";
