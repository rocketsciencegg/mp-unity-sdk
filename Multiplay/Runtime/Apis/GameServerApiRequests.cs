...
using RocketScience.Services.Multiplay.Scheduler;
using RocketScience.Services.Multiplay.Http;
using Unity.Services.Authentication.Internal;

namespace RocketScience.Services.Multiplay.GameServer
{
    ...
    /// <summary>
    /// PatchServerAllocationRequest
    /// Update the provided server and allocation ID with new state
    /// </summary>
    [Preserve]
    internal class PatchServerAllocationRequest : GameServerApiBaseRequest
    {
        ...
        /// <summary>Accessor for patchServerAllocationRequestBody </summary>
        [Preserve]
        public RocketScience.Services.Multiplay.Models.PatchServerAllocationRequestBody PatchServerAllocationRequestBody { get; }
        string PathAndQueryParams;

        /// <summary>
        /// PatchServerAllocation Request Object.
        /// Update the provided server and allocation ID with new state
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        /// <param name="allocationId">ID of the game server allocation.</param>
        /// <param name="patchServerAllocationRequestBody">The state changes to propagate to the provided server and allocation.</param>
        [Preserve]
        public PatchServerAllocationRequest(long serverId, System.Guid allocationId, RocketScience.Services.Multiplay.Models.PatchServerAllocationRequestBody patchServerAllocationRequestBody = default(RocketScience.Services.Multiplay.Models.PatchServerAllocationRequestBody))
        {
            ServerId = serverId;

            AllocationId = allocationId;

            PatchServerAllocationRequestBody = patchServerAllocationRequestBody;
            PathAndQueryParams = $"/v1/servers/{serverId}/allocations/{allocationId}";
        ...
        {
            if(PatchServerAllocationRequestBody != null)
            {
                return ConstructBody(PatchServerAllocationRequestBody);
            }
            return null;
        }
    ...
    /// <summary>
    /// V1ServersServerIdHoldDeleteRequest
    /// Remove server hold by server ID
    /// </summary>
    [Preserve]
    internal class V1ServersServerIdHoldDeleteRequest : GameServerApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        public long ServerId { get; }
        ...
        /// <summary>
        /// V1ServersServerIdHoldDelete Request Object.
        /// Remove server hold by server ID
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        [Preserve]
        public V1ServersServerIdHoldDeleteRequest(long serverId)
        {
            ServerId = serverId;

            PathAndQueryParams = $"/v1/servers/{serverId}/hold";
    ...
    /// <summary>
    /// V1ServersServerIdHoldGetRequest
    /// Server hold status by server ID
    /// </summary>
    [Preserve]
    internal class V1ServersServerIdHoldGetRequest : GameServerApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        public long ServerId { get; }
        ...
        /// <summary>
        /// V1ServersServerIdHoldGet Request Object.
        /// Server hold status by server ID
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        [Preserve]
        public V1ServersServerIdHoldGetRequest(long serverId)
        {
            ServerId = serverId;
    ...
    /// <summary>
    /// V1ServersServerIdHoldPostRequest
    /// Hold server by server ID
    /// </summary>
    [Preserve]
    internal class V1ServersServerIdHoldPostRequest : GameServerApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        public long ServerId { get; }
        /// <summary>Accessor for holdRequestBody </summary>
        [Preserve]
        public RocketScience.Services.Multiplay.Models.HoldRequestBody HoldRequestBody { get; }
        string PathAndQueryParams;

        /// <summary>
        /// V1ServersServerIdHoldPost Request Object.
        /// Hold server by server ID
        /// </summary>
        /// <param name="serverId">ID of the game server.</param>
        /// <param name="holdRequestBody">Additional parameters supplied to the reservation request.</param>
        [Preserve]
        public V1ServersServerIdHoldPostRequest(long serverId, RocketScience.Services.Multiplay.Models.HoldRequestBody holdRequestBody = default(RocketScience.Services.Multiplay.Models.HoldRequestBody))
        {
            ServerId = serverId;

            HoldRequestBody = holdRequestBody;
            PathAndQueryParams = $"/v1/servers/{serverId}/hold";
        ...
        public byte[] ConstructBody()
        {
            if(HoldRequestBody != null)
            {
                return ConstructBody(HoldRequestBody);
            }
            return null;
        }
