...
using RocketScience.Services.Qos.Scheduler;
using RocketScience.Services.Qos.Http;
using Unity.Services.Authentication.Internal;

namespace RocketScience.Services.Qos.QosDiscovery
{
    ...
    /// </summary>
    [Preserve]
    public class QosDiscoveryApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    public class ListServersRequest : QosDiscoveryApiBaseRequest
    {
        ...
        /// <param name="ifNoneMatch">ETag value from a previous response for conditional request</param>
        [Preserve]
        public ListServersRequest(string fleetid, string ifNoneMatch = default(string))
        {
            Fleetid = fleetid;

            IfNoneMatch = ifNoneMatch;
            PathAndQueryParams = $"/v1/fleets/{fleetid}/servers";
